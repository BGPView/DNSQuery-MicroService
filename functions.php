...
/**
 * Convert an prefix to a decimal range
 *
 * @param string $prefix A Prefix
 * @return Array with to and from
 */
function getPrefixRange($prefix)
{
    $prefixParts = explode('/', $prefix);

    if (getInputType($prefixParts[0]) === 4) {
        $startIpDec = ip2dec($prefixParts[0]) - 1;
        $endIpDec = $startIpDec + IPv4cidrIpCount()[$prefixParts[1]] + 1;
    } else {
        $startIpDec = number_format(ip2dec($prefixParts[0]) - 1, 0 , '', '');
        $endIpDec = $startIpDec + IPv6cidrIpCount()[$prefixParts[1]] + 1;
...
function IPv4cidrIpCount($reverse = false)
{
    // 'cidr' => 'IP count'
    $array = [
        '0'     =>  '4294967296',
...
function IPv6cidrIpCount($reverse = false)
{
    // 'cidr' => 'IP count'
    $array = [
        '128' => '1',
